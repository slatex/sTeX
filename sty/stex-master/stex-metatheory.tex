...
\begin{@module}[ns=\c_stex_metatheory_ns_str,meta=NONE]{Metatheory}
  ...
  \symdef[args=a]{aseqdots}{#1\comp{,\ellipses}}{#1\comp,#2}

  \symdef[args=a,prec=nobrackets]{aseqdots}{#1\comp{,\ldots}}{#1\comp,#2} 
  \symdef[args=ai,prec=nobrackets]{aseqfromto}{#1\comp,\ldots\comp,#2 }{#1\comp,#2} 
  ...
  \STEXexport{
    ...
    \def\naseqli{\csname sequence-from-to\endcsname[li]}
    \def\uivar{\csname sequence-index\endcsname[ui]}
    \def\nasequi{\csname sequence-from-to\endcsname[ui]}
  }
