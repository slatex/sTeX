...
\svnInfo $Id: stex.tex 2228 2013-01-13 12:52:32Z kohlhase $
\svnKeyword $HeadURL: https://svn.kwarc.info/repos/stex/trunk/sty/stex.tex $
\usepackage{hyperref}
\makeindex
\floatstyle{boxed}
...
(e.g. TeXlive~\cite{TeXLive:on} and MikTeX~\cite{MiKTeX:on}). The development version can from
\begin{center}
  {\url{https://svn.kwarc.info/repos/stex/trunk/sty/}\meta{package}/}
\end{center}
