...
\begin{tikzpicture}
  ...
  \node (problem) at (2,5) {problem};
  \node (tikzinput) at (4,4) {tikzinput};

  \node (stex) at (0,5) {stex};
  \node (smultiling) at (-2,5) {smultiling};

  \node (smglomsty) at (-1.5,6) {smglom.sty};
  \node (mikoslidessty) at (1,6) {mikoslides.sty};
  \node (hwexamsty) at (3.5,6) {hwexam.sty};

  \node (smglomcls) at (-1.5,7) {smglom.cls};
  \node (mikoslidescls) at (1,7) {mikoslides.cls};
  \node (hwexamcls) at (3.5,7) {hwexam.cls};
