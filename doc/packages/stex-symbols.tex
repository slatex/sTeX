...
$\newbinarysymbol{a}{b}$
    ...
    We just declared a new symbol |newbinarysymbol| with |args=2|
...
\begin{sfragment}{Argument Types}
    ...
    symbol with \stexcode"\symdecl{foo}[args=3]" is
    equivalent to writing \stexcode"\symdecl{foo}[args=iii]",
...
$\summation{\svar{x}}{1}{\svar{n}}{\svar{x}}^2$
    ...
    \begin{sfragment}{\texttt a-Type Arguments}
        ...
        take one additional argument for each |a|-type argument that
        ...
        in the |a|-type argument, and accumulates them into |#2|,
