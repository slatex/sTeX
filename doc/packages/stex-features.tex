...
\begin{function}{\usestructure}
  The |\usestructure{<struct>}| macro is e.g. used in multilingual settings as a parallel
  to the |mathstructure| environment. It issues a
  |\usemodule{.../<struct>-structure}| that gives the current group access to all the semantic
