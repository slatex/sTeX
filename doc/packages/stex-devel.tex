...
\begin{sfragment}{Modules}
  ...
  \begin{itemize}
    ...
    \item |\c_stex_module_|\meta{uri}|_dependencies|: lists
      all module dependencies of this module 
      (see \cs{stex_add_module_dependency:nnn}).
    \item |\c_stex_module_|\meta{uri}|_declarations|: lists
      all declarations in this module (see \cs{stex_add_module_decl:nnnnnnN}).
    \item |\c_stex_module_|\meta{uri}|_notations|: lists
      all notations introduced in this module
  ...
  \begin{sfragment}{Iterating Over Modules}
    \begin{sfunction}{stex_iterate_all_modules:n}{\stex_iterate_all_modules:n}
      iterates over all modules currently in scope, passing the
      namespace and module name as first and second arguments to
      the code given as argument.
    \end{sfunction}

    Iteration can be stopped using
    \begin{sfunction}{stex_iterate_break:,stex_iterate_break:n}{\stex_iterate_break:,\stex_iterate_break:n}
      stops iteration. Must be the last macro called in the macro code
      provided to the iteration function. The |:n|-variant subsequently
      inserts the code provided. 
    \end{sfunction}
  \end{sfragment}
