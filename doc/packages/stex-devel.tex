...
\begin{sfragment}{Symbols}
  ...
  \begin{sfunction}{_stex_invoke_symbol:nnnnnnnN,
    ...
    initializes \dcs[STEXInternalSymbolAfterInvokationTL],
...
\begin{sfragment}{Structural Features}
  ...
  \begin{sfunction}{
    stex_structural_feature_morphism:nnnn,
    ...
    \begin{syntax}\dcs\marg{moprhismname}\marg{typeid}\marg{archive}\marg{domain}\end{syntax}
