...
\begin{sfragment}{Justifications}
  ...
  \begin{environment}{justification}
    ...
    \pkg{stex-proofs} package. This environment totally invisible to the formatted result;
...
\begin{sfragment}{Proof Structure}
  ...
  \begin{environment}{subproof}
    ...
    \DescribeMacro{method}|method| key can be used to give the name of the proof method
...
\begin{function}{\pstlabelstyle}
  ...
  |\pstlabelstyle{|\meta{style}|}| sets the style; see Figure~\ref{fig:pstlabel} for an
  overview of styles. Package writers can add additional styles by adding a macro
  |\pst@make@label@|\meta{style} that takes two arguments: a comma-separated list of
