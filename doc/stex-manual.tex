...
\begin{dangerbox}
  ...
  not immediately interesting, but might be useful 
  to know when debugging (or to avoid) errors.
\end{dangerbox}
...
\begin{sfragment}{Using \sTeX}
  ...
  \begin{sfragment}{How Knowledge is Organized in \sTeX}
    ...
    \begin{mmtbox}
      \sTeX archives are simultaneously \mmt archives, and the same
      directory structure is consequently used.

      \sTeX modules correspond to \omdoc/\mmt \emph{theories}.
      \stexcode"\importmodule"s (and similar constructions) induce an 
      \mmt |include|s and other \emph{theory mosphisms},
      thus giving rise to a \emph{theory graph} in the \omdoc sense.

      Symbol declarations induce \omdoc/\mmt \emph{constants},
      with optional (formal) \emph{type} and \emph{definiens} components.

      Finally, \sTeX expressions are converted to \omdoc/\mmt terms,
  ...
  \begin{sfragment}{A First \sTeX Document}
    ...
    \begin{document}
      \begin{smodule}{GeometricSeries}
        ...
        \begin{sdefinition}[for=geometricSeries]
            ...
            \[\defeq{\geometricSeries}{\definiens{\infinitesum{n}{1}{
              \realdivide[frac]{1}{
                \realpower{2}{n}
              }
            }}}.\]
    ...
    \begin{mdframed}
        ...
        is the \pdftooltip{\textcolor{blue}{series}}{URI: http://mathhub.info/smglom/calculus?series?series}
        ...
        \pdftooltip{\textcolor{blue}{:=}}{URI: http://mathhub.info/smglom/mv?defeq?definitional-equation}
          \mathop{\pdftooltip{\textcolor{blue}{\sum}}{URI: http://mathhub.info/smglom/calculus?series?infinitesum}}_{n=1}^{
          \pdftooltip{\textcolor{blue}\infty}{URI: http://mathhub.info/smglom/calculus?series?infinitesum}} \frac{1}{2^n}.\]
    ...
    \begin{latexcode}[numbers=none,aboveskip=0pt,belowskip=0pt]
    \begin{smodule}{GeometricSeries}
      ...
    \end{smodule}
    \end{latexcode}
